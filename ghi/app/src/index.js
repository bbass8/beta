...
export async function loadData(){
  ...
  if(salesPeopleResponse.ok && customerResponse.ok && salesResponse.ok && responseTechnicians.ok && responseAppointments.ok ) {
    ...
    root.render(
      <React.StrictMode>
        ...
        sales={salesData.sales} technicians={dataTechnicians.technicians} appointments={dataAppointments.appointments}/>
      </React.StrictMode>
    )
  }
  else {
